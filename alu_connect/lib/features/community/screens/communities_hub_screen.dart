...
/// The main "Communities" tab: search, filters, my communities, featured + list.
...
class _CommunitiesHubScreenState extends State<CommunitiesHubScreen> {
  ...
  void _openHub(Community c) {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => CommunityDiscussionScreen(community: c)),
    );
  }
        ...
        builder: (context, _) {
          ...
          return ListView(
            ...
            children: [
              ...
              const Text(
                'Discover organizations and connect with peers.',
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [
              community.accentColor.withValues(alpha: 0.85),
              AppColors.surface,
            ],
          ),
